        ...
        <div className="navbar-container">
          ...
          <div className="navbar-user">
              ...
              <img
                src={
                  user?.avatar?.startsWith("http")
                    ? user.avatar
                    : `${process.env.PUBLIC_URL}${user?.avatar || "/avatars/default.png"}`
                }
                alt={user?.username}
              />
            </div>
            <span className="user-name">
              {user?.displayName || user?.username} {user?.isAdmin && "(Admin)"}
            </span>

            {!user?.isAdmin && (
              <button
                onClick={handleClaimDailyBonus}
                className="btn btn-gift btn-sm navbar-gift-btn"
              >
                🎁 Nhận Quà
              </button>
            )}
            ...
            <button
              ...
              className="btn btn-danger btn-sm navbar-logout-btn"
            >
              Đăng xuất
            </button>
          </div>
